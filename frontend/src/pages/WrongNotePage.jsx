    ...
    >
      ...
      >
        ...
        >
          ...
          {wn.exampleKr && (
            <p className="text-xs text-gray-400 leading-snug">{wn.exampleKr}</p>
          )}
        </div>
      </motion.div>
    </div>
      ...
      <main className="flex-1 overflow-y-auto px-4 py-5 pb-40 max-w-4xl mx-auto w-full">
        ...
        {!loading && !error && wrongNotes.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-600 font-semibold text-lg">오답 단어가 없어요!</p>
            <p className="text-gray-400 text-sm">퀴즈를 풀면 틀린 단어가 자동으로 저장됩니다.</p>
          </motion.div>
        )}
